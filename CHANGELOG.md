...
- **Module ISO/IEC 27001:2022 facultatif** : statut de la démarche et périmètre couvert dans la fiche entité, badge « Certifié ISO 27001 » avec date de validité (tableau de bord, note au comité, Trust Center), déclaration des 93 contrôles de l'annexe A par thème ou contrôle par contrôle, import d'une déclaration d'applicabilité, pré-remplissage des exigences NIS2, DORA et CRA correspondantes, alertes sur les contrôles exclus, recoupement par référentiel.
